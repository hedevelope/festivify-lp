...
const iconPositions = [
  { top: '-40%', left: '-40%', rotation: '-15deg' },
  { top: '-40%', right: '-40%', rotation: '15deg' },
  { bottom: '-40%', left: '-40%', rotation: '15deg' },
  { bottom: '-40%', right: '-40%', rotation: '-15deg' },
  { top: '-50%', left: '50%', transform: 'translateX(-50%)', rotation: '0deg' },
  { bottom: '-50%', left: '50%', transform: 'translateX(-50%)', rotation: '0deg' },
];
